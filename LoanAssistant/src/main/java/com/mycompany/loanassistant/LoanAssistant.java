...
correct.
            ", "Interest Input Error", JOptionPane.DEFAULT_OPTION,
JOptionPane.INFORMATION_MESSAGE
            );
return;
        }
...
entry.
                \nPlease correct
                .", "Number of Payments Input Error",
...
want to use the minimum payment
...
entry.
                \nPlease correct
                .", "Payment Input Error", JOptionPane.DEFAULT_OPTION,
JOptionPane.INFORMATION_MESSAGE
                );
return;
            }
...
// apply one more payment
        ...
        analysisTextArea.append("\n" + "Interest Paid $" + newDecimalFormat("0.00").format((months - 1) * payment + finalPayment - balance));
...
// invalid character foundvalid = false;
                }
            }
        }
        tf.setText(s);
